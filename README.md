...
| **Windows + NodeJS 25.2.1 (x64)** | [![Phrost Engine (x64)](https://github.com/joseph-montanez/Phrost/actions/workflows/windows-x64-node-build.yml/badge.svg)](https://github.com/joseph-montanez/Phrost/actions/workflows/windows-x64-node-build.yml) | [**Download Latest**](https://nightly.link/joseph-montanez/Phrost/workflows/windows-x64-node-build.yml/master/Phrost-Windows-x64-Node.zip) |
